...
function validateForm(){
    ...
    if (username.length == 0){
        usernameInput.nextElementSibling.innerHTML = "Invalid name!";
    }else if (username.length < 6){
        usernameInput.nextElementSibling.innerHTML = "Your name longer than 6 characters!";
    }else {
    ...
    if (message.length == 0){
        messageInput.nextElementSibling.innerHTML = "Invalid Comment!";
    }else {
